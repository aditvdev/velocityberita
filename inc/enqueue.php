...
if ( ! function_exists( 'mjlah_scripts' ) ) {
	...
	function mjlah_scripts() {
		...
		wp_enqueue_style( 'mjlah-styles', get_template_directory_uri() . '/css/theme.min.css', array(), $css_version );
		wp_enqueue_style( 'mjlah-woocomerce-styles', get_template_directory_uri() . '/css/woocomerce.min.css', array(), $css_version );
