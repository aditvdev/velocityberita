...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'justg' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'justg' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'justg' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'justg' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'justg' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'justg' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'justg' ); ?>',
} );
#>
