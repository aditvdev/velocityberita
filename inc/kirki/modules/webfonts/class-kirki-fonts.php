...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'justg' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'justg' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'justg' ),
			'200'       => esc_html__( 'Light 200', 'justg' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'justg' ),
			'300'       => esc_html__( 'Book 300', 'justg' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'justg' ),
			'400'       => esc_html__( 'Normal 400', 'justg' ),
			'regular'   => esc_html__( 'Normal 400', 'justg' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'justg' ),
			'500'       => esc_html__( 'Medium 500', 'justg' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'justg' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'justg' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'justg' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'justg' ),
			'700'       => esc_html__( 'Bold 700', 'justg' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'justg' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'justg' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'justg' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'justg' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'justg' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'justg' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'justg' ),
		);
	}
