...
<head>
	...
	<title><?php esc_html_e( 'Application authentication request', 'mjlah' ); ?></title>
...
<body class="wc-auth wp-core-ui">
	<h1 id="wc-logo"><img src="<?php echo esc_url( WC()->plugin_url() ); ?>/assets/images/woocommerce_logo.png" alt="<?php esc_attr_e( 'mjlah', 'mjlah' ); ?>" /></h1>
