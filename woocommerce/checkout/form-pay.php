	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'justg' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'justg' ); ?></th>
			</tr>
		</thead>
		<tbody>
